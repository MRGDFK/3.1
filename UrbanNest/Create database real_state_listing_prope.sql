...
create table property(
    ...
    use real_state_listing_properties;
	insert into property(prop_id, seller_id, prop_location, porp_type, prop_description, prop_size, prop_status)
    values(1,1111,"Badda","Flat","1200 sqft","hjdfvbasjkbdfkjashvdfjahsdfv","unsold");
